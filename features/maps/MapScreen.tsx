    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto px-6 pb-32">
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-3xl font-black text-white font-display tracking-tight uppercase">{t('title')}</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="space-y-1">
            <h4 className="text-sm font-black text-white uppercase tracking-wider">{t('map_title')}</h4>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">{t('map_desc')}</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-1">
            <h4 className="text-sm font-black text-white uppercase tracking-wider">Offline Ready</h4>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">Map boundaries and booth locations are stored locally for access without internet.</p>
          </div>
        </motion.div>
      </div>
    </div>
